...
//		 
		// Add car object and link to owners and save  these to db
		 ...
		 Car car1 = new Car(1,"Ford", "Mustang", "Red", "ADF-1121", 2021, 59000, owner1);
		 Car car2 = new Car(2,"Nissan", "Leaf", "White","SSJ-3002", 2019, 29000, owner2);
		 Car car3 = new Car(3,"Toyota", "Prius", "Silver","KKO-0212", 2020, 39000, owner2);
